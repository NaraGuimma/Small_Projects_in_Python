...
# PS: The value of the angles will be input by the user, instead of using the list given previously
import turtle
...
lovelace.pendown()
current_heading = 0
angles = input("How many times do you to run the program?")
angles = int(angles)
for ang in range(angles):
    angle = input("Input an angle value from 0-360. It could be a negative value as well")
    angle = float(angle)
